...
file1_name = [filename for filename in all_files if filename.endswith("_notA1Phase_A1Phase_corrected.csv")]
file2_name = [filename for filename in all_files if filename.endswith("_notA2Phase_A2Phase_corrected.csv")]
file3_name = [filename for filename in all_files if filename.endswith("_notA3Phase_A3Phase_corrected.csv")]
file4_name = [filename for filename in all_files if filename.endswith("_notAPhase_APhase_corrected.csv")]
...
for i in range (len(file1_name)):
    ...
    with open(file1_name[i], 'r') as file1, open(file2_name[i], 'r') as file2, open(file3_name[i], 'r') as file3, open(file4_name[i], 'r') as file4:
        ...
        csv_reader1_prob = list(csv.reader(open(file1_name[i][:-32]+"notA1Phase_A1Phase_probabilistic_output.csv")))
        csv_reader2_prob = list(csv.reader(open(file1_name[i][:-32]+"notA2Phase_A2Phase_probabilistic_output.csv")))
        csv_reader3_prob = list(csv.reader(open(file1_name[i][:-32]+"notA3Phase_A3Phase_probabilistic_output.csv")))

        
    # Define the output CSV file name
    # output_file_name = file1_name[i][:-22] + 'all_subtypes_corrected.csv'
    output_file_name = file1_name[i][:-32] + 'all_subtypes_corrected.csv'
